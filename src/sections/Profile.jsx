...
function Profile() {
  return (
    <section id='profile' className='relative w-full min-h-screen bg-gradient-to-r from-amber-100 to-amber-200 p-8 xl:px-36'>
      <div className='py-4 text-center text-3xl'>
        <h1 className='font-notoSansJp text-center font-semibold text-slate-600'>プロフィール</h1>
        <div className='bg-secondary rounded-full mx-10 md:mx-24'>
          <h2 className='text-slate-700 font-semibold tracking-wide'>Aloha Nani Pua Melia Chika</h2>
          <h2 className='font-notoSansJp text-slate-700 font-semibold tracking-wide'>鵜澤智華</h2>
        </div>
      </div>
